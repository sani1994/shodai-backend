...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [ 'id','product_name','product_name_bn', 'product_image','product_unit', 'product_unit_name', 'product_price','product_meta','product_meta_name','product_last_price','is_approved','product_description','product_description_bn']
